function [Eout,Count,MapVet]=OpticalIFFTNPam(t,SymPer,StopPoint,E1,AngVec,...
...
%     [Eout1,Eout2] = DelayInterfExp(t,TimDel,PhaDel,E1,E0);                 %Sends the input signal to the DI
 ...
 %program It has got to an end.
    if ActStag>StopPoint
        ...
        [Eout1,Eout2] = DelayInterfExp(t,TimDel,PhaDel,E1(MapVet(1),:),E1(MapVet(2),:));
        Eout   = Eout1;
        ...
        [EoutAux1,Count,MyVetAux1] = OpticalIFFTN(t,SymPer,StopPoint,...
                                        E1,AngVec,ActStag,Count,E0,Vetaux);%Calculating the next interaction of the FFT
        [EoutAux2,Count,MyVetAux2] = OpticalIFFTN(t,SymPer,StopPoint,...
                                        E1,AngVec,ActStag,Count,E0,MapVet);%Calculating the next interaction of the FFT
        [Eout1,Eout2]              = DelayInterfExp(t,TimDel,PhaDel,EoutAux2,EoutAux1);%Sends the input signal to the DI
