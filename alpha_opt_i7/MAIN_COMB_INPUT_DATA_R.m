...
Gain_steps  = 5+2;%Number of different gains used in the optical ring
phase_steps = 10+2;%Number of different phase delays that will be used
Vbias_steps = 10+1;%Number of different Bias voltage that will be used
%
...
N_combination = phase_steps*Vbias_steps*Varm1_steps*Varm2_steps;           %Variable to calculate the percentage for completition of the simulation
%
