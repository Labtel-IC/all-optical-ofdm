...
MatPos = MatPos - 1;
Vet_Lab = [{'Frequência Central [Hz]'} {'Fase entre Eletrodos'} {'Tensão Braço 1 [V]'} {'Tensão Braço 2 [V]'} {'Tensão de Polarização [V]'} {'Index dos Arquivos'} {'Picos Encontrados'} {'Ganho'}];
...
xlswrite(Name,[{'FC '};{'Pha'};{'VA2'};{'VA1'};{'Vbi'};{'Fid'};{'NPe'};...
