function [Eout,Count,MapVet]=OpticalFFTG(f,SymPer,StopPoint,E1,AngVec,...
...
% to think in all possible steps .
    ...
    [Eout1,Eout2] = DelayInterfG(f,TimDel,PhaDel,E1,E0);                 %Sends the input signal to the DI
 ...
 %program It has got to an end.
    if ActStag>StopPoint
        ...
        [EoutAux1,Count,MyVetAux1] = OpticalFFTG(f,SymPer,StopPoint,...
                                     Eout2,AngVec,ActStag,Count,E0,Vetaux);%Calculating the next interaction of the FFT
        [EoutAux2,Count,MyVetAux2] = OpticalFFTG(f,SymPer,StopPoint,...
        ...
        Eout   = [EoutAux2;EoutAux1];                                      %Storing the received Output from the FFT.
    end
end
