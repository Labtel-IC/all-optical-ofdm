function [Eout,Count,MapVet]=OpticalFFTGT(f,SymPer,StopPoint,E1,AngVec,...
...
% to think in all possible steps .
    ...
    elseif nargin == 4%The minimum input arguments required.
        ...
        E0      = zeros(size(E1,1),size(E1,2),'gpuArray');                                     %Variable for the second input of the MZI
 ...
 %program It has got to an end.
    if ActStag>StopPoint
        ...
        [EoutAux1,Count,MyVetAux1] = OpticalFFTGT(f,SymPer,StopPoint,...
                                     Eout2,AngVec,ActStag,Count,E0,Vetaux);%Calculating the next interaction of the FFT
        [EoutAux2,Count,MyVetAux2] = OpticalFFTGT(f,SymPer,StopPoint,...
