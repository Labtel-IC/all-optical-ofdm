function [Eout,Count,MapVet]=OpticalIFFTNP(t,SymPer,StopPoint,E1,AngVec,...
...
%     [Eout1,Eout2] = DelayInterfExp(t,TimDel,PhaDel,E1,E0);                 %Sends the input signal to the DI
 ...
 %program It has got to an end.
    if ActStag>StopPoint
        ...
        [Eout1,Eout2]              = DelayInterfExp(t,TimDel,PhaDel,EoutAux1,EoutAux2);%Sends the input signal to the DI
        
        MapVet = [MyVetAux2 MyVetAux1];                                    %Storing the received mapping vector.
        Eout   = Eout1;                                                    %Storing the received Output from the FFT.
    end
end
