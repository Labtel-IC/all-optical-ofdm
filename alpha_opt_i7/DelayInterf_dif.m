function [ Eout1,Eout2 ] = DelayInterf_dif( t,TimDel,PhaDel,E1,E0,CoupConst,...
                                                          ExpCoef,MutCoef )
...
f=time2freq(t);
E11d = ifft(fft(E11).*exp(-1j*2*pi*TimDel.*f));
...
Eout1 = ExpCoef.*(cos(CoupConst).*E11d + MutCoef*1j*sin(CoupConst).*E12d);
Eout2 = ExpCoef.*(cos(CoupConst).*E12d + MutCoef*1j*sin(CoupConst).*E11d);
