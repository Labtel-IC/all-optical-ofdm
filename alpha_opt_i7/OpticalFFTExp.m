function [ Eout,Count,PhaMat ] = OpticalFFTExp(t,SymPer,MaxNumStag,Count,E1...
...
%c means, it can filter just 32 subcarriers. For furter implementation it is
...
% this function will be called again.
        ActStag = ActStag + 1;
        [EoutAux1,Count,PhaMat]= OpticalFFTExp(t,SymPer,MaxNumStag,Count,Eout1,0,ActStag,PhaDel,PhaMat);
...
%  (180/pi)*PhaDel
%  (180/pi).*PhaMat
        [EoutAux2,Count,PhaMat] = OpticalFFTExp(t,SymPer,MaxNumStag,Count,Eout2,0,ActStag,PhaDel,PhaMat);
