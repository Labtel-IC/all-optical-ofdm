function [Eout,Count,MapVet]=OpticalIFFTN(f,SymPer,StopPoint,E1,AngVec,...
...
% to think in all possible steps .
    ...
    elseif nargin == 4%The minimum input arguments required.
        ...
        E0      = zeros(1,length(E1));                                     %Variable for the second input of the MZI
...
%     [Eout1,Eout2] = DelayInterfExp(t,TimDel,PhaDel,E1,E0);                 %Sends the input signal to the DI
 ...
 %program It has got to an end.
    if ActStag>StopPoint
        ...
        [Eout1,Eout2] = DelayInterfExp(f,TimDel,PhaDel,E1(MapVet(2),:),E1(MapVet(1),:));
        Eout   = Eout2;
        ...
        [EoutAux1,Count,MyVetAux1] = OpticalIFFTN(f,SymPer,StopPoint,...
                                        E1,AngVec,ActStag,Count,E0,Vetaux);%Calculating the next interaction of the FFT
        [EoutAux2,Count,MyVetAux2] = OpticalIFFTN(f,SymPer,StopPoint,...
                                        E1,AngVec,ActStag,Count,E0,MapVet);%Calculating the next interaction of the FFT
        [Eout1,Eout2]              = DelayInterfExp(f,TimDel,PhaDel,EoutAux1,EoutAux2);%Sends the input signal to the DI
