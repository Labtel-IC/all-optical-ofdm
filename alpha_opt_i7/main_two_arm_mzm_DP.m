    ...
    for Va2=1:Varm2_steps                                                  %For each possible value of Amplitude of the RF signal at the Lower arm
        for Ph12=1:phase_steps                                             %For each Phase differency between the RF sgnals
            for Gai=1:Gain_steps                                           %For each gain given to the output optical signal
                tic
                for Inc0=1:phi_0_steps*V2bias_steps*V1bias_steps           %For each Phase differency between Uper and Lower arm
                    ...
                    To_Eval{S}.V1b = U10;                          % Stores the bias voltage applied at the Uper arm
                    To_Eval{S}.V2b = U20;                          % Stores the bias voltage applied at the Lower arm
                    To_Eval{S}.VPh = phi_0;                        % Stored the voltage applied at the phase controler between Uper and Lower arms
