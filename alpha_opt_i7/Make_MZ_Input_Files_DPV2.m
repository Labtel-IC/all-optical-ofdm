...
%c   
%c
%c   Set_MZ_Input_Data_DP. - Function that will create and load the files with
%c the given in data.
%c
%c
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for Inc=1:phase_steps                                                      %Main loop for all possible combinations of the input
    for Inc3=1:V2bias_steps                                                %Secundary loop for the possible combinations
        U10              =0;                                               %Variation of the Vbias
        U20              = V2bias(Inc3);                                   %Variation of the Vbias
        [MZ_Input_Sdata] = Set_MZ_Input_Data_DP(S,L,U10,U20,U_pi1,U_pi2,...%Functionresponsible to create the input files
        eta1,eta2,V1pi0,V2pi0,Vphi0,nopt,nel,alfa_ins,phi_0,alfa0,LocalV2);
        S                = S+1;
    end
end