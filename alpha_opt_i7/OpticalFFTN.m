function [Eout,Count,MapVet]=OpticalFFTN(f,SymPer,StopPoint,E1,AngVec,...
...
% to think in all possible steps .
 ...
 %program It has got to an end.
    if ActStag>StopPoint
        ...
        [EoutAux1,Count,MyVetAux1] = OpticalFFTN(f,SymPer,StopPoint,...
                                     Eout2,AngVec,ActStag,Count,E0,Vetaux);%Calculating the next interaction of the FFT
        [EoutAux2,Count,MyVetAux2] = OpticalFFTN(f,SymPer,StopPoint,...
