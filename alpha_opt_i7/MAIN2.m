...
for CurrentModula=ThisModula
    for CurrentTest=1:ThisTest
        ...
        VetElecPowerI BerDPSK BerDQPSK CurrentTest VetOptiPowerUp mm ...
        ...
        Ber4PAMS PrintinEye SetCpSampZer ReceptorNoise
        ...
        if CurrentModula == 2
            ...
            b = [Ber4PAM(CurrentTest,berpos1);Ber4PAM(CurrentTest,berpos2)]
...
'AddingNoiseO','Ber4PAMS','AberLevS','ValsLevS' );
                else
                    save(SavingAT,'NumbOfTest',...
...
'ValsLevS');
        ...
        elseif CurrentModula == 1
            ...
            b = [BerOOK(CurrentTest,berpos1);BerOOK(CurrentTest,berpos2)]
...
,'CarrPass', 'CarrUsedDo','CarrUsedUp','ObsCarrUsed','CarrRecPowUp',...
'CarrRecPowDo','osnrf','osnr','snr','AddingNoiseF','AddingNoiseE',...
'AddingNoiseO','BerOOKS','AberLevS','ValsLevS');
                PastTime = 0;
                tic;
            end
        elseif CurrentModula == 3
            ...
            b=[BerDQPSK(CurrentTest,berpos1);BerDQPSK(CurrentTest,berpos2)]
...
'ValsLevIS','AberLevQS','ValsLevQS');
                PastTime = 0;
                tic;
            end
        elseif CurrentModula == 4
            berpos1 = 1:2:size(BerDPSKS,2);
            berpos2 = 2:2:size(BerDPSKS,2);
            b = [BerDPSKS(CurrentTest,berpos1);BerDPSKS(CurrentTest,berpos2)]
